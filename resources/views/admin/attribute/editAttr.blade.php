    ...
    <form  method="Post" class="form form-horizontal" id="form-attr-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-5 col-sm-6">
                <input type="text" class="input-text" value="{{$attr->attr_name}}" placeholder="" id="attr_name" name="attr_name">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box">
                    <input name="attr_index" type="radio" id="attr_index-1" 
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box">
                    <input name="attr_type" type="radio" id="attr_type-1" 
                           @if($attr->attr_type ==0)
                           checked 
                           @endif                           
                           value="0">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-5 col-sm-6 skin-minimal">
                <div class="radio-box">
                    <input name="attr_input_type" type="radio" id="attr_input_type-1" 
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-5 col-sm-6">
                <textarea name="attr_values" cols="" rows="" class="textarea"  placeholder="一行代表一个可选值">{{$attr->attr_values}}</textarea>               
            </div>
        </div>      
        <div class="row cl">
...
$(function () {
    ...
    $("#form-attr-add").validate({
        ...
        submitHandler: function (form) {
            $(form).ajaxSubmit({
                type: 'post',
                url: '/admin/attribute/edit/'+{{$attr->id}}, 
